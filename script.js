...
button.addEventListener("click", function () {
  ...
  emailjs
    .send("service_g726g8l", "template_9apoh0p")
    .then(function () {
...
function drawText() {
  ...
  if (frameNumber >= 200 && frameNumber < 500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "everyday day I cannot believe how lucky I am",
      canvas.width / 2,
  ...
  if (frameNumber > 500 && frameNumber < 800) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
  ...
  if (frameNumber > 1700 && frameNumber < 2000) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
  ...
  if (frameNumber >= 3200 && frameNumber < 99999) {
